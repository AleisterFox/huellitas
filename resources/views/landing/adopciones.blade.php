...
<main>
    <section id="portada-donaciones">
        <figure>
            ...
            <img src="{{ asset('images/' . $instance->adoption_banner_image) }}" alt="">
            @else
            <img src="img/adopciones.jpg" alt="">
            @endif
        </figure>
        <h1>{{ $instance->adoption_banner_title }}</h1>
    </section>
    <section id="donativos">
        ...
        <div class="container fta">
            <div class="middle-content">
                <div class="left">
                    @if (!$instance->adoption_banner_description_1)
                    ...
                    @else
                    {!! $instance->adoption_banner_description_1 !!}
                    @endif
                </div>
                <div class="right">
                    <figure>
                        @if ($instance->adoption_banner_image_1)
                        <img src="{{ asset('images/' . $instance->adoption_banner_image_1) }}" alt="">
                        @else
            ...
            <div class="bottom-content">
                <div class="left">
                    <figure>
                        ...
                        <img src="{{ asset('images/' . $instance->adoption_banner_image_2) }}" alt="">
                        @else
                ...
                <div class="right">
                    @if (!$instance->adoption_banner_description_2)
                    ...
                    @else
                    {!! $instance->adoption_banner_description_2 !!}
                    @endif
                </div>
            </div>
