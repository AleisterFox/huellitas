...
<html lang="es" xml:lang="es" style="overflow-x: visible">
  <head>
    ...
    <meta
      name="Keywords"
      content="Doctor, Bulmaro Irving Padilla Gomez, salud, cardiología, cardiologo, internista, especialidad, científico, investigación, Puerto Vallarta, México"
    />
        ...
        <div class="container">
          ...
          <div class="right">
            ...
            <div class="buttons">
              ...
              <a href="javascript:void(0);" class="button add__product"
      ...
      <div class="cart__modal cart__modal--active">
        <div class="cart__modal--container">
          ...
          <div class="cart__bottom">
            <a href="javascript:void(0)" class="keep__buying"
              >Seguir comprando</a
            >
